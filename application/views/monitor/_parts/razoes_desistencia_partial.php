<div class="modal" tabindex="-1" role="dialog" id="razoes-desistencia">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?=base_url()?>monitor/Processos/manifestacaoReu" method="post" role="form">
        <div class="modal-header">
          <h5 class="modal-title">Motivo da desistência?</h5>
        ...
        <div class="modal-footer">
          ...
          <input type="hidden" id="manifestacao-tipo-rejeicao" name="ManifestacaoTipo" value="">
