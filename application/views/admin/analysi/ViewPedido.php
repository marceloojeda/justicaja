...
<script src="<?php echo base_url();?>assets/js/pedido_view.js" type="text/javascript"></script>

<section id="section-pedido-view">
			...
			<div class="w3-margin-top">
				<div class="w3-margin">
					<form action="<?php echo base_url();?>admin/dashboard/SalvarAnalise" method="post">
						<?php
						echo form_hidden("StatusPedido", $dataPost["Analise"]["Status"]);
						echo form_hidden("AnaliseId", $dataPost["Analise"]["Id"]);
						echo form_hidden("PedidoId", $dataPost["Pedido"]["Id"]);
						?>

						<textarea name="Analise" rows="5" class="w3-input w3-border w3-margin-bottom" required><?php echo $dataPost["Analise"]["Observacao"]; ?>
						</textarea>
						...
						<div class="w3-twothird w3-margin-bottom">
							<div class="w3-row w3-section">
								...
								<div class="w3-rest">
									<select name="Status" class="w3-select w3-border" id="ddlStatus">
										<option value="0">Não Iniciado</option>
										<option value="1">Em Andamento</option>
										<option value="2">Rejeitado</option>
										<option value="3">Cancelado</option>
										<option value="4">PAP apto à conversão</option>
						...
						<div class="w3-third w3-right-align w3-margin-bottom">
							...
							<button class="w3-btn w3-blue" id="btnSalvar" type="submit">Salvar</button>
						</div>
					</form>
				</div>
			</div>
