...
<section id="pedidoList">
	<div class="container">
		<div class="w3-card w3-margin">
			<form action="<?php echo base_url();?>admin/AnalysiPedido/manifestacoesPedidos" method="post">
				<?php 
					...
					<div class="w3-row-padding">
						...
						<div class="w3-third w3-margin-top w3-margin-bottom">
							<select class="w3-select w3-border" name="Status" id="ddlStatus">
								...
								<option value="5">Reu Indeciso</option>
								<option value="6">Aceito pelo Réu</option>
								<option value="2">Rejeitado</option>
								<option value="3">Cancelado</option>
								<option value="4">Convertido em Processo</option>
		...
		<?php $this->load->view('admin/analysi/lista_paps_manifestacoes');?>
	</div>
</section>
